...
export default function MapView({
  ...
  return (
    <div className="relative w-full h-full">
      {mapError && (
        <div
          className={`absolute top-4 left-4 right-4 px-4 py-3 rounded z-50 flex items-start justify-between ${
        ...
        >
          ...
          {mapError.includes("WARNING") && (
            <button
              ...
              className="ml-3 flex-shrink-0 text-yellow-800 hover:text-yellow-900 transition-colors"
